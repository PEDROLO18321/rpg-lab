...
const SYSTEMS = [
  ...
  },
  {
    ...
    status: "available" as const,
    desc: "Sistema de RPG autoral ambientado numa linha do tempo alternativa nas Regiões Desconhecidas. 35 espécies, 20 classes e progressão até o nível 99.",
    highlights: ["35 espécies e 28 planetas", "20 classes + Formas de Sabre", "Poderes Gerais e PP", "Multiclasse e progressão até nível 99"],
  },
];
