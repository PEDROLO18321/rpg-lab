        ...
        ? {
            cthulhuSheet: {
              create: {
                ...
                sanTemp: s.sanTemp,
                pmTemp: s.pmTemp,
                skillChecks: jsonIn(s.skillChecks),
                skills: jsonIn(s.skills),
                background: jsonIn(s.background),
                weapons: jsonIn(s.weapons),
                equipment: s.equipment,
                notes: s.notes,
                insanityData: jsonIn(s.insanityData),
                spellsData: jsonIn(s.spellsData),
              },
            },
          }
        : {}),
