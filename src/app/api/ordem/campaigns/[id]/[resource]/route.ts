...
import { MASTER_RESOURCES, pickFields } from "@/lib/ordem/masterResources";

// POST — cria um filho (npc, combatant, clue, clock, …) na operação.
export async function POST(
  ...
  const cfg = MASTER_RESOURCES[resource];
  ...
  const created = await (prisma as any)[cfg.delegate].create({
