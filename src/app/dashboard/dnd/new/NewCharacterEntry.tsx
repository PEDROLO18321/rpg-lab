...
const MODES = [
  {
    ...
    desc: "Construa seu personagem do zero, com acesso total a todas as etapas: raça, classe, antecedente, atributos, equipamento e magias.",
    cta: "Começar do Zero",
    icon: (
  ...
  },
  {
    ...
    desc: "Escolha o nível e (opcionalmente) o nome e a classe — o sistema gera um personagem completo e válido, já progredido, seguindo as regras de D&D 5e.",
    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <h1 style={{ fontFamily: "var(--font-cinzel), serif", fontSize: "clamp(1.6rem, 4vw, 2.2rem)", fontWeight: 700, color: "var(--text)" }}>
          Como você quer <span className="text-gold">criar</span> seu personagem?
        </h1>
      </div>
            ...
            <div
              ...
              style={{
                ...
                background: isHovered
                  ...
                  : "var(--surface)",
                border: `1px solid ${isHovered ? "rgba(201,148,31,0.4)" : "rgba(255,255,255,0.07)"}`,
                borderRadius: "var(--radius-xl)",
                boxShadow: isHovered
                  ? "0 20px 56px rgba(0,0,0,0.5), 0 0 32px rgba(201,148,31,0.22)"
            ...
            >
              <div
                style={{
                  ...
                  background: isHovered ? "rgba(201,148,31,0.13)" : "var(--surface-2)",
                  border: `1px solid ${isHovered ? "rgba(201,148,31,0.4)" : "var(--border)"}`,
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: isHovered ? "#c9941f" : "var(--text-muted)",
              ...
              <p style={{ fontSize: "0.68rem", fontWeight: 700, color: isHovered ? "#c9941f" : "var(--text-subtle)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 6, transition: "color 0.2s" }}>
                {m.subtitle}
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: "0.84rem", fontWeight: 700, color: isHovered ? "#c9941f" : "var(--text-muted)", transition: "color 0.2s" }}>
                {m.cta}
