...
import { getCampaign, saveCampaign, type Campaign } from "@/lib/dnd/campaignStorage";
...
export default function CampaignPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  function update(updated: Campaign) {
    setCampaign(updated);
  ...
  return (
    <div style={{ minHeight: "100vh", background: "transparent" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "36px 24px 80px" }}>
        ...
        {tab === "bestiary" && <Bestiary campaign={c} onChange={update} />}
      </main>
    </div>
  );
}
