...
const MODES = [
  ...
  },
  {
    ...
    desc: "Já tem uma ficha de Tormenta 20 exportada deste site em outro lugar? Envie o arquivo .json e importe o herói completo.",
  ...
  if (mode === "import")
    return (
      <ImportJsonForm
        ...
        redirectBase="/dashboard/tormenta"
        accent={ACCENT_LIGHT}
