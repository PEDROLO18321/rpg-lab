...
export function CampaignAgenda({ api }: { api: TormentaApi }) {
  ...
  const lab: React.CSSProperties = { display: "block", fontSize: "0.68rem", fontWeight: 700, color: ACCENT_LIGHT, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 6 };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div style={card}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
          <input id={dateId} type="datetime-local" value={value} onChange={(e) => setValue(e.target.value)} style={{ padding: "9px 12px", background: "var(--surface-2)", border: `1px solid ${ACCENT_BORD}`, borderRadius: "var(--radius)", color: "var(--text)", fontSize: "0.86rem" }} />
