...
import { TormentaGuide } from "./TormentaGuide";
...
export default function CampaignPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { status: cStatus, api } = useTormentaCampaign(id);
  ...
  if (cStatus === "notfound" || !api) {
    return (
      <div style={{ minHeight: "100vh", background: "transparent", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
        ...
        <Link href="/dashboard/tormenta/mestre" style={{ color: ACCENT_LIGHT, fontSize: "0.86rem", textDecoration: "none" }}>
