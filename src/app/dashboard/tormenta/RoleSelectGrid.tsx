...
const ROLES = [
  {
    ...
    desc: "Crie e gerencie seus heróis de Arton. Preencha fichas interativas, acompanhe atributos, magias e equipamentos em tempo real.",
    href: "/dashboard/tormenta/jogador",
    accentColor: ACCENT,
    accentGlow: "rgba(160,24,24,0.22)",
    borderAccent: "rgba(160,24,24,0.4)",
    icon: (
  ...
  },
  {
    id: "mestre",
    label: "Mestre",
    subtitle: "Contador de Histórias",
    desc: "Comande a aventura em Arton. Gerencie campanhas, crie NPCs e ameaças, e conduza histórias contra a Tormenta.",
    href: "/dashboard/tormenta/mestre",
    accentColor: ACCENT,
    accentGlow: "rgba(160,24,24,0.22)",
    borderAccent: "rgba(160,24,24,0.4)",
    icon: (
          ...
          <Link key={role.id} href={role.href} style={{ textDecoration: "none", display: "flex" }} onMouseEnter={() => setHovered(role.id)} onMouseLeave={() => setHovered(null)}>
            <div
              style={{
                ...
                background: isHovered ? "linear-gradient(135deg, rgba(160,24,24,0.1) 0%, rgba(160,24,24,0.03) 100%)" : "var(--surface)",
