...
const SYSTEMS = [
  ...
  },
  {
    ...
    description:
      "Sistema de RPG autoral numa linha do tempo alternativa, focado na exploração das Regiões Desconhecidas. 35 espécies, 25 classes e progressão até o nível 1111.",
    image: starWarsImg,
    status: "available" as const,
