    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ padding: "18px 20px", background: SW.panel, border: `1px solid ${ACCENT_BORD}`, borderRadius: "var(--radius-xl)", boxShadow: `0 0 24px ${SW.glow}, inset 0 1px 0 rgba(255,255,255,0.03)` }}>
        <div className="sw-clue-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 12, marginBottom: 12 }}>
          <div><Field label="Título" style={labelStyle}><input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Ex: Manifesto de carga selado" style={inputStyle} /></Field></div>
          <div><Field label="Onde/Como foi achada" style={labelStyle}><input value={source} onChange={(e) => setSource(e.target.value)} placeholder="Ex: Terminal, NPC X" style={inputStyle} /></Field></div>
        </div>
