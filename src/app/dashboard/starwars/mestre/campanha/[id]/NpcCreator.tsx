...
const FAMOUS_CHARACTERS: FamousCharacter[] = [
  ...
  { name: "Luke Skywalker 100% (potencial máximo)", source: "Canon", species: "Humano", role: "Grão-Mestre Jedi / O Lado da Luz — nível 40 em Padawan Jedi + 40 em O Lado da Luz (liberada aos 20) + 1031 em Bônus", level: 1111,
  ...
  { name: "O Lado da Luz", source: "Canon", species: "Variável (build genérico)", role: "O Lado da Luz", level: 40,
    ...
    description: "Build de referência da classe de Caminho no nível máximo (40). Liberada aos 20 numa classe-base ligada à Força. Arquétipo Sensível à Força." },
