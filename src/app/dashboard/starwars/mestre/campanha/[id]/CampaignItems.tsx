...
const TYPE_OPTIONS: { value: ItemType; label: string }[] = [
  { value: "arma", label: "Arma" }, { value: "equipamento", label: "Equipamento" },
  { value: "nave", label: "Nave/Veículo" }, { value: "artefato", label: "Artefato" }, { value: "misc", label: "Misc" },
];
      ...
      {adding && (
        <div style={{ background: SW.panel, border: `1px solid ${ACCENT_BORD}`, borderRadius: "var(--radius-xl)", padding: "20px 24px", boxShadow: `0 0 24px ${SW.glow}, inset 0 1px 0 rgba(255,255,255,0.03)` }}>
          ...
          <div className="sw-item-form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 14 }}>
            <div style={{ gridColumn: "1 / -1" }}><Field label="Nome" style={labelStyle}><input style={inputStyle} value={newItem.name} onChange={(e) => setNewItem({ ...newItem, name: e.target.value })} placeholder="Ex: Sabre de luz de Kest Vhorrun" autoFocus /></Field></div>
