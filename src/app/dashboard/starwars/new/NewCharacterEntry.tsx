...
const MODES = [
  {
    ...
    desc: "Construa seu personagem do zero, com acesso total a todas as etapas: espécie, planeta, classe, atributos, perícias e caminho.",
    cta: "Começar do Zero",
    icon: (
  ...
  },
  {
    ...
    desc: "Escolha o nível e (opcionalmente) o nome e a classe — o sistema gera um personagem completo e válido, já progredido, seguindo as regras do sistema.",
  ...
  },
  {
    ...
    desc: "Já tem uma ficha de Star Wars exportada deste site em outro lugar? Envie o arquivo .json e importe o personagem completo.",
...
export function NewCharacterEntry({ userId, systemId }: Props) {
  ...
  if (mode === "import")
    return (
      <ImportJsonForm
        systemId={systemId}
        systemLabel="Star Wars"
        expectedFormat="rpglab.starwars.v1"
        importUrl="/api/starwars/characters/import"
        redirectBase="/dashboard/starwars"
        accent={ACCENT}
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        <span className="section-label" style={{ display: "block", marginBottom: 12 }}>Star Wars</span>
        <h1 style={{ fontFamily: "var(--font-cinzel), serif", fontSize: "clamp(1.6rem, 4vw, 2.2rem)", fontWeight: 700, color: "var(--text)" }}>
          Como você quer <span style={{ color: ACCENT }}>criar</span> seu personagem?
        </h1>
      </div>
            ...
            <div
              ...
              style={{
                ...
                background: isHovered
                  ? "linear-gradient(135deg, rgba(59,130,196,0.1) 0%, rgba(59,130,196,0.03) 100%)"
                  : "var(--surface)",
                border: `1px solid ${isHovered ? "rgba(59,130,196,0.4)" : "rgba(255,255,255,0.07)"}`,
                borderRadius: "var(--radius-xl)",
                boxShadow: isHovered
                  ? "0 20px 56px rgba(0,0,0,0.5), 0 0 32px rgba(59,130,196,0.22)"
            ...
            >
              <div
                style={{
                  ...
                  background: isHovered ? "rgba(59,130,196,0.13)" : "var(--surface-2)",
                  border: `1px solid ${isHovered ? "rgba(59,130,196,0.4)" : "var(--border)"}`,
              ...
              <p style={{ fontSize: "0.68rem", fontWeight: 700, color: isHovered ? ACCENT : "var(--text-subtle)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 6, transition: "color 0.2s" }}>
                {m.subtitle}
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: "0.84rem", fontWeight: 700, color: isHovered ? ACCENT : "var(--text-muted)", transition: "color 0.2s" }}>
                {m.cta}
