    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ padding: "18px 20px", background: "var(--surface)", border: `1px solid ${ABORD}`, borderRadius: "var(--radius-xl)" }}>
        <div className="cth-clues-form-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 12, marginBottom: 12 }}>
          <div><label style={labelStyle}>Título</label><input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Ex: Diário rasgado" style={inputStyle} /></div>
          <div><label style={labelStyle}>Onde/Como foi achada</label><input value={source} onChange={(e) => setSource(e.target.value)} placeholder="Ex: Sótão, NPC X" style={inputStyle} /></div>
        </div>
