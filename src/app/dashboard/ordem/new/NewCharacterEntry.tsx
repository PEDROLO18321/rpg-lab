...
const MODES = [
  {
    ...
    desc: "Construa seu agente do zero, com acesso total a todas as etapas: atributos, origem, classe, perícias, equipamento e conceito.",
    cta: "Começar do Zero",
    icon: (
  ...
  },
  {
    ...
    desc: "Escolha o NEX e (opcionalmente) o nome e a classe — o sistema gera um agente completo e válido, já progredido, seguindo as regras de Ordem Paranormal.",
  ...
  },
  {
    ...
    desc: "Já tem uma ficha de Ordem Paranormal exportada deste site em outro lugar? Envie o arquivo .json e importe o agente completo.",
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        <span className="section-label" style={{ display: "block", marginBottom: 12 }}>Ordem Paranormal</span>
        <h1 style={{ fontFamily: "var(--font-cinzel), serif", fontSize: "clamp(1.6rem, 4vw, 2.2rem)", fontWeight: 700, color: "var(--text)" }}>
          Como você quer <span style={{ color: ACCENT }}>criar</span> seu agente?
        </h1>
      </div>
            ...
            <div
              ...
              style={{
                ...
                background: isHovered
                  ...
                  : "var(--surface)",
                border: `1px solid ${isHovered ? "rgba(255,255,255,0.32)" : "rgba(255,255,255,0.07)"}`,
                borderRadius: "var(--radius-xl)",
                boxShadow: isHovered
                  ? "0 20px 56px rgba(0,0,0,0.5), 0 0 32px rgba(255,255,255,0.14)"
            ...
            >
              <div
                style={{
                  ...
                  background: isHovered ? "rgba(255,255,255,0.1)" : "var(--surface-2)",
                  border: `1px solid ${isHovered ? "rgba(255,255,255,0.32)" : "var(--border)"}`,
